...
./call.sh "--fullcheck-find=1 --useralloc=1" 
./call.sh "--fullcheck-backwards=1" 
./call.sh "--fullcheck-backwards=1 --duplicate=1" 
./call.sh "--fullcheck-backwards=1 --useralloc=1" 
./call.sh "--useralloc=1" 
...
./call.sh "--use-aes=1 --reopen=1" 
./call.sh "--use-recovery=1 --reopen=1" 
./call.sh "--cacheunlimited=1" 
./call.sh "--data_access_mode=HAM_DAM_SEQUENTIAL_INSERT --reopen=1" 
./call.sh "--data_access_mode=HAM_DAM_RANDOM_WRITE --reopen=1" 
./call.sh "--direct_access=1 --inmemorydb=1"
